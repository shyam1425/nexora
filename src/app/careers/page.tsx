...
export default async function CareersPage({ searchParams }: { searchParams: SearchParams }) {
  ...
  const result = await queryOrUnavailable('careers_listing', () =>
    prisma.$transaction([
